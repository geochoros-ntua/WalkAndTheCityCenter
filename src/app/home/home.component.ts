...
export class HomeComponent implements OnInit {
  ...
  pubs = [
    ...
    {
      name: "Bartzokas-Tsiompras, A., & Photis, Y. N. (2021). Microscale walkability indicators for fifty-nine European downtown neighbourhoods [Data set]. Mendeley. https://doi.org/10.17632/PVTWCJS365.1",
    },
    {
      name: "Bartzokas-Tsiompras A., Paraskevopoulos Y., Sfakaki A., Photis Y.N. (2021) Addressing Street Network Accessibility Inequities for Wheelchair Users in Fifteen European City Centers. In: Nathanail E.G., Adamos G., Karakikes I. (eds) Advances in Mobility-as-a-Service Systems. CSUM 2020. Advances in Intelligent Systems and Computing, vol 1278. Springer, Cham. https://doi.org/10.1007/978-3-030-61075-3_98",
    },
    {
      name: "Bartzokas-Tsiompras, A., Tampouraki, E. M., & Photis, Y. N. (2020). Is walkability equally distributed among downtowners? Evaluating the pedestrian streetscapes of eight European capitals using a micro-scale audit approach. International Journal of Transport Development and Integration, 4(1), 75–92. https://doi.org/10.2495/TDI-V4-N1-75-92",
    },
  ]
